...
module.exports = function(isValidElement, throwOnDirectAccess) {
  ...
  function createChainableTypeChecker(validate, expectedDefinition) {
    ...
    // expose the actual prop type definition as it was generated by the proptypes function.
    chainedCheckType.propTypeDefinition = expectedDefinition;
    chainedCheckType.isRequired.propTypeDefinition = expectedDefinition;
  ...
  function createInstanceTypeChecker(expectedClass) {
    ...
    var expectedDefinition = {
      type: 'instance',
      expectedValues: [expectedClass.name]
    }
    return createChainableTypeChecker(validate, expectedDefinition);
  }
  ...
  function createShapeTypeChecker(shapeTypes) {
    ...
    for (var key in shapeTypes) {
      var shapeKey = shapeTypes[key];
      if (!shapeKey) {
        continue;
      }
      customShapeTypes[key] = shapeKey.propTypeDefinition
    }
