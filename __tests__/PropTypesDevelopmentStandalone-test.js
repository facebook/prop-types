...
describe('PropTypesDevelopmentStandalone', () => {
  ...
  describe('IterableOf Type', () => {
    ...
    it('should warn if called manually in development', () => {
      spyOn(console, 'error');
      expectThrowsInDevelopment(PropTypes.iterableOf({ foo: PropTypes.string }), {
        foo: 'bar',
      });
      expectThrowsInDevelopment(PropTypes.iterableOf(PropTypes.number), [
        1,
        2,
        'b',
      ]);
  ...
  describe('TupleOf Type', () => {
    ...
    it('should warn if called manually in development', () => {
      spyOn(console, 'error');
      expectThrowsInDevelopment(PropTypes.tupleOf({ foo: PropTypes.string }), {
        foo: 'bar',
      });
      expectThrowsInDevelopment(PropTypes.tupleOf([PropTypes.number]), [
        1,
        2,
        'b',
      ]);
  ...
  describe('MapOf Type', () => {
    ...
    it('should fail with invalid entries in the map', () => {
      typeCheckFail(
    ...
    it('should fail with invalid complex types', () => {
      function Thing() { }
      const name = Thing.name || '<<anonymous>>';
    ...
    it('should fail when passed something other than a map', () => {
      typeCheckFail(
    ...
    it('should not fail when passing an empty map', () => {
      typeCheckPass(PropTypes.mapOf([PropTypes.number, PropTypes.number]), new Map());
    });

    it('should be implicitly optional and not fail without values', () => {
    ...
    it('should fail if called manually in development', () => {
      spyOn(console, 'error');
      expectThrowsInDevelopment(PropTypes.mapOf({ foo: PropTypes.string }), {
        foo: 'bar',
      });
      expectThrowsInDevelopment(PropTypes.mapOf([PropTypes.number, PropTypes.number]), [
        1,
        2,
        'b',
      ]);
  ...
  describe('SetOf Type', () => {
    ...
    it('should fail with invalid values in the set', () => {
      typeCheckFail(
    ...
    it('should fail when passed something other than a set', () => {
      typeCheckFail(
        PropTypes.setOf(PropTypes.number),
        { '0': 'maybe-array', length: 1 },
        'Invalid prop `testProp` of type `object` supplied to ' +
    ...
    it('should not fail when passing an empty set', () => {
